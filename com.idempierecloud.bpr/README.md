...
- New callout
    ...
    * Example: com.idempierecloud.bpr.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.idempierecloud.bpr.process
    * Example: com.idempierecloud.bpr.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.idempierecloud.bpr.form
    * Example: com.idempierecloud.bpr.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.idempierecloud.bpr.event
    * Example: com.idempierecloud.bpr.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.idempierecloud.bpr.model
    * Example: com.idempierecloud.bpr.model.MTableExample

## Folder estructure

```
    com.idempierecloud.bpr
        |_.settings
...
- New callout
    * Create callout in package `com.idempierecloud.bpr.callout`, extends from `CustomCallout`
    * Register callout in `com.idempierecloud.bpr.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `com.idempierecloud.bpr.process`, extends from `CustomProcess`
    * Register process in `com.idempierecloud.bpr.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `com.idempierecloud.bpr.form`, extends from `CustomForm`
    * Register form in `com.idempierecloud.bpr.component.FormFactory`. Example:
...
- New event
    * Create event in package `com.idempierecloud.bpr.event`, extends from `CustomEvent`
    * Register event in `com.idempierecloud.bpr.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `com.idempierecloud.bpr.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `com.idempierecloud.bpr.component.ModelFactory`. Example:
