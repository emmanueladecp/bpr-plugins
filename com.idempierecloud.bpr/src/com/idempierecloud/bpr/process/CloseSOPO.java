...
public class CloseSOPO extends CustomProcess  {
    ...
    protected String doIt() throws Exception {
        ...
        int skipCount = 0;
            ...
            sql.append("SELECT C_Order_ID FROM C_Order WHERE c_bpartner_id=1011519 AND docstatus = 'CO' AND EXTRACT(YEAR FROM created) IN (2023, 2024) order by CREATED desc ");
