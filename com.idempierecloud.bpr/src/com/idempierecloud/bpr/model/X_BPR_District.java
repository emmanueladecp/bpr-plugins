...
/** Generated Model for BPR_District
 *  @author iDempiere (generated) 
 *  @version Release 9 - $Id$ */
@org.adempiere.base.Model(table="BPR_District")
public class X_BPR_District extends PO implements I_BPR_District, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20240416L;

    /** Standard Constructor */
    public X_BPR_District (Properties ctx, int BPR_District_ID, String trxName)
    {
      super (ctx, BPR_District_ID, trxName);
      /** if (BPR_District_ID == 0)
        {
    ...
    /** Standard Constructor */
    public X_BPR_District (Properties ctx, int BPR_District_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, BPR_District_ID, trxName, virtualColumns);
      /** if (BPR_District_ID == 0)
        {
			setBPR_District_ID (0);
			setC_City_ID (0);
    ...
    /** Load Constructor */
    public X_BPR_District (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_BPR_District[")
	...
	*/
	...
	/** Set BPR_District_UU.
		@param BPR_District_UU BPR_District_UU
	*/
	public void setBPR_District_UU (String BPR_District_UU)
	{
		set_Value (COLUMNNAME_BPR_District_UU, BPR_District_UU);
	}

	/** Get BPR_District_UU.
		@return BPR_District_UU	  */
	public String getBPR_District_UU()
	{
		return (String)get_Value(COLUMNNAME_BPR_District_UU);
	}
