...
import com.idempierecloud.bpr.process.CancelAndMoveShipment;
...
import com.idempierecloud.bpr.process.SetCreditUsedBPartner;
...
public class ProcessFactory extends CustomProcessFactory {
	...
	protected void initialize() {
		...
		registerProcess(SetCreditUsedBPartner.class);
