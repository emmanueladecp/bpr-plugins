...
public class MovementTest extends AbstractTestCase {
	...
	private static final int DocType_MaterialSusut = 1000061;
	...
	public void test_materialmovement_create_confirmmovement() throws Exception{
		...
		MMovement movementSusut = new Query(Env.getCtx(), MMovement.Table_Name, "C_DocType_ID=? AND MoveReference=?", getTrxName())
				.setParameters(DocType_MaterialSusut, movement.getDocumentNo())
				.first();

		assertEquals(MMovement.STATUS_Completed, movementSusut.getDocStatus());
